...
-- ========================================================================================
-- 1. Tạo một view có tên view_users_firstname để hiển thị danh sách các người dùng có họ “Nguyễn”. View này cần bao gồm các cột: user_id, username, full_name, email, created_at.
...
-- 2. Tiến hành hiển thị lại view vừa tạo được.
SELECT * FROM social_network_pro.view_users_firstname;

-- 3. Thêm một nhân viên mới vào bảng User có họ “Nguyễn”. Sau đó, truy vấn lại view view_users_firstname để kiểm tra xem nhân viên vừa thêm có xuất hiện trong view hay không.
INSERT INTO users (username, full_name, gender, email, password, birthdate, hometown) VALUES
('tu', 'Nguyễn Anh Tú', 'Nam', 'tu@gmail.com', '777', '2005-01-21', 'Cao Bằng');
SELECT * FROM social_network_pro.view_users_firstname; -- Có hiện

-- 4. Thực hiện xóa nhân viên vừa thêm khỏi bảng Users. Sau đó, truy vấn lại view view_users_firstname để kiểm tra xem nhân viên vừa bị xóa có còn xuất hiện trong view không. 
delete from users
where user_id = 26;
SELECT * FROM social_network_pro.view_users_firstname; -- Có xóa được
