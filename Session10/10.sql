...
values
('anhyeuem', 'Nguyễn Quang anhyeuem', 'Nu', 'tuannu@gmail.com', '122', '1999-07-30', 'TP.HCN');

select * from view_users_firstname;

delete from view_users_firstname
where username = 'anhyeuem';
...
select u.full_name, p.total_user_post
from view_users_firstname u join view_user_post p on u.user_id = p.user_id;
...
From posts
where created_at = year(2026) and user_id = 1;
...
-- em chua chay thu nma nhanh hon
...
as 
select u.user_id , u.username , vu.total_user_post as 'total_posts' 
from users u join view_user_post vu on u.user_id = vu.user_id;
...
from users u;
-- bai nay e dung ai vi hom case e nghi, de hom sau em hoc lai ve cai day a
