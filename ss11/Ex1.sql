...
DELIMITER ;
CALL users_in(1);
DROP PROCEDURE IF EXISTS users_in;
...
CALL CalculatePostLikes(9, @likes);

SELECT @likes AS total_likes;
...
SET @msg = ''; 														-- Trường hợp hợp lệ
CALL CreatePostWithValidation(1, 'Bài viết hợp lệ nè', @msg);
SELECT @msg;
...
CALL CalculateUserActivityScore(1, @score, @level);							-- Gọi procedure
