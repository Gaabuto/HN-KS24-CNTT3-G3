...
-- =========================================================================================
/*
1. Tạo stored procedure có tham số IN nhận vào p_user_id:
...
-- 2. Gọi lại thủ tục vừa tạo với user cụ thể mà bạn muốn
call p_user_id(2);

-- 3. Xóa thủ tục vừa tạo.
drop procedure p_user_id;
